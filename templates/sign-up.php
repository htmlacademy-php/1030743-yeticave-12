<main>
  ...
  <form class="form container <?=isset($errors) ? "form--invalid" : ""; ?>" action="register.php" method="post" autocomplete="off"  enctype="multipart/form-data"> <!-- form
  --invalid -->
    ...
    <div class="form__item <?=isset($errors['message']) ? "form__item--invalid" : ""; ?>">
      ...
      <textarea id="message" name="message" placeholder="Напишите как с вами связаться"><?=$form_data['message']?></textarea>
