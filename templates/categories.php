      ...
      <?php if ($lots): ?>
        ...
        <?php if ($pages_count > 1): ?>
          <ul class="pagination-list">
            <?php if ($cur_page > 1): ?>
              <li class="pagination-item pagination-item-prev"><a href="category.php?id=<?=strval($_GET['id']); ?>&page=<?=$cur_page - 1;?>">Назад</a></li>
            <?php else: ?>
            ...
            <?php endif ?>
              <?php foreach ($pages as $page): ?>
                ...
                <?php else: ?>
                  <li class="pagination-item"><a href="category.php?id=<?=strval($_GET['id']); ?>&page=<?=$page;?>"><?=$page;?></a></li>
                <?php endif ?>
              <?php endforeach; ?>
            <?php if ($pages_count > $cur_page): ?>
              <li class="pagination-item pagination-item-next"><a href="category.php?id=<?=strval($_GET['id']); ?>&page=<?=$cur_page + 1;?>">Вперед</a></li>
            <?php else: ?>
