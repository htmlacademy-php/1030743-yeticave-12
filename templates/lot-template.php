        ...
        <?php if (isset($lot)): ?>
            ...
            <div class="lot-item__content">
                ...
                <div class="lot-item__right">
                    <?php if (isset($user_name_lot_add)) {
                        if (isset($current_time)) {
                            if (isset($lot_end_date)) {
                                if (isset($last_bet_user)) {
                                    if (isset($_SESSION['user']) && ($_SESSION['user']['name'] !== $user_name_lot_add)
                                        && ($current_time < $lot_end_date) && ($_SESSION['user']['name'] !== $last_bet_user)): ?>
                                        <div class="lot-item__state">
                                            ...
                                            <div class="lot-item__cost-state">
                                                <div class="lot-item__rate">
                                                    ...
                                                    <span class="lot-item__cost"><?= isset($lot_price) ? htmlspecialchars($lot_price) : ""; ?></span>
                                                </div>
                                                <div class="lot-item__min-cost">
                                                    Мин. ставка <span><?= isset($min_bet) ? htmlspecialchars($min_bet) : ""; ?></span>
                                                </div>
                                            </div>
                                            <form class="lot-item__form <?= isset($error) ? "form__item--invalid" : ""; ?>"
                                                ...
                                                <p class="lot-item__form-item form__item ">
                                                    ...
                                                    <input id="cost" type="text" name="cost"
                                                           placeholder="<?= isset($min_bet) ? htmlspecialchars($min_bet) : ""; ?>">
                                                    <input id="id" type="hidden" name="id" value="<?= isset($lot_id) ? htmlspecialchars($lot_id) : ""; ?>">
