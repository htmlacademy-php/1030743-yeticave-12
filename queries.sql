...
INSERT INTO lot (id, creation_date, lot_name, lot_description, image, start_price, end_date, bet_step, user_lot_add_id, user_winner_id, category_id) VALUES
  (1, NOW(), '2014 Rossignol District Snowboard', 'Сноуборд сноубордический №1', 'img/lot-1.jpg', '10999', NOW() + INTERVAL 10 DAY, 500, 2, 2, 1),
  (2, NOW(), 'DC Ply Mens 2016/2017 Snowboard', 'Сноуборд для сноубординга №2', 'img/lot-2.jpg', '159999', NOW() + INTERVAL 15 DAY, 500, 1, 1, 1),
  (3, NOW(), 'Крепления Union Contact Pro 2015 года размер L/XL','крепление которое крепко крепит крепеж', 'img/lot-3.jpg', '159999', NOW() + INTERVAL 20 DAY, 500, 2, 2, 2),
  (4, NOW(), 'Ботинки для сноуборда DC Mutiny Charocal','Ботинки сноубордические угольные ога', 'img/lot-4.jpg', '10999', NOW() + INTERVAL 25 DAY, 500, 1, 1, 3),
...
-- добавляет данные в "ползователи"
